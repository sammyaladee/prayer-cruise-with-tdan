    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            {livestream?.isLive 
              ...
              : "Join us every Friday at 8:00 PM WAT / BST for Prayer Cruise"
            }
          </p>
          {livestream?.scheduledTime && !livestream.isLive && (
            <p className="text-gray-500 mt-2">
              Next session: {new Date(livestream.scheduledTime).toLocaleString('en-US', {
                weekday: 'long',
                month: 'long',
                day: 'numeric',
                hour: 'numeric',
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          {!livestream?.youtubeUrl && !livestream?.facebookUrl ? (
            <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">No Active Livestream</h3>
              <p className="text-gray-600 mb-6 max-w-md mx-auto">
                There is currently no active livestream. Join us every Friday at 8:00 PM for Prayer Cruise.
              </p>
            ...
            <div className="space-y-8">
              {/* YouTube Embed */}
              {livestream?.youtubeUrl && getYouTubeEmbedUrl(livestream.youtubeUrl) && (
              ...
              {livestream?.facebookUrl && (
                <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
                  ...
                  <div className="relative pb-[56.25%] h-0">
                    <iframe
                      src={getFacebookEmbedUrl(livestream.facebookUrl)}
                      className="absolute top-0 left-0 w-full h-full"
