...
export default function LivestreamPage() {
  // Get all data from context - no fetching needed!
  const { liveStreams, pastStreams, loading } = useLivestream();
  ...
  const hasAnyStreams = liveStreams.length > 0 || pastStreams.length > 0;
