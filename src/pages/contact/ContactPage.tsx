...
export default function ContactPage() {
  ...
  const handleSubmit = (e:any) => {
    ...
    const subject = encodeURIComponent(formData.subject || 'Message from Prayer Cruise Website');
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              <div className="bg-white rounded-2xl shadow-lg p-8">
                ...
                <div className="space-y-6">
                  ...
                  <a 
                    ...
                    className="flex items-start gap-4 hover:opacity-80 transition-opacity items-center"
                  >
                  ...
                  {/* Facebook Page */}
                  <a 
                    href="https://facebook.com/profile.php?id=61565806229788" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="flex items-start gap-4 hover:opacity-80 transition-opacity items-center"
                  >
              ...
              {/* Live Session Info */}
              <div className="bg-gradient-to-r from-blue-600 to-orange-500 rounded-2xl shadow-lg p-8 text-white">
                <h2 className="text-2xl font-bold mb-4">Join Us Live</h2>
                <div className="space-y-4">
                  ...
                  <p className="text-blue-50 text-sm mt-4">
                    Connect with us on YouTube or Facebook for our live prayer sessions every Friday evening.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-8 py-4 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all duration-300"
                >
                  Send Message
                </button>
              </div>
